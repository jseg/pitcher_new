...
enum {CMD_LOAD, CMD_PRESET, CMD_FIRE, CMD_HAND, CMD_EEPROMSETUP, CMD_PITCH, CMD_YAW, CMD_SPRING, CMD_HOME, CMD_MOVE, CMD_STATE, CMD_SERIAL, CMD_NUDGE, CMD_SAVE };
const char cmdlist[] = //must be in the same order as enum
      "load preset fire hand eepromsetup pitch yaw spring home move state serial nudge save"; 
